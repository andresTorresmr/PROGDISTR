...
import { delete_method } from "../../../services";
import { useFetchAndLoad } from "../../../hooks";
import { deleteMethod } from "../../../redux/states/method.state";

const DeleteMethodModal = ({ id, openDelete, setOpenDelete }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await callEndpoint(delete_method(id));
